...
###    
    ...
    train_path = 'E:\ACSE\Project\Bones Segmentation\ConvNet Gp\M27_train.npy'
    validation_path = 'E:\ACSE\Project\Bones Segmentation\ConvNet Gp/M27_eval.npy'
    test_path = 'E:\ACSE\Project\Bones Segmentation\ConvNet Gp/M27_test.npy'
    trainlabel_path = 'E:\ACSE\Project\Bones Segmentation\ConvNet Gp/M27_tl.npy'
    validationlabel_path = 'E:\ACSE\Project\Bones Segmentation\ConvNet Gp/M27_el.npy'
    testlabel_path = 'E:\ACSE\Project\Bones Segmentation\ConvNet Gp/M27_testl.npy'
    
    
#    train_path = 'E:/ACSE/Project/Traffic Gaussian/Codes/ConvnetsAsGP/Data/123/train.csv'
#    validation_path = 'E:/ACSE/Project/Traffic Gaussian/Codes/ConvnetsAsGP/Data/123/validaiton.csv'
#    test_path = 'E:/ACSE/Project/Traffic Gaussian/Codes/ConvnetsAsGP/Data/123/test.csv'
#    trainlabel_path = 'E:/ACSE/Project/Traffic Gaussian/Codes/ConvnetsAsGP/Data/123/trainlabel.csv'
#    validationlabel_path = 'E:/ACSE/Project/Traffic Gaussian/Codes/ConvnetsAsGP/Data/123/validaitonlabel.csv'
#    testlabel_path = 'E:/ACSE/Project/Traffic Gaussian/Codes/ConvnetsAsGP/Data/123/testlabel.csv'
#
...
#    trainlable=np.float64(trainlable_read)
    ...
    trainlable=np.load(trainlabel_path)
    
    print("Traffic training data loaded from:", validation_path)
...
#    validationlable=np.float64(validationlable_read)
    validationset = np.load(validation_path)
    validationlable=np.load(validationlabel_path)
        
    print("Traffic training data loaded from:", test_path)
...
#    testlable=np.float64(testlable_read)      
    testset = np.load(test_path)
    testlable=np.load(testlabel_path)
